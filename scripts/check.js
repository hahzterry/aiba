...
if(!nextHtml.includes('<script src="src/core/legacy-adapter.js?v=refactor10"></script>'))fail("next legacy adapter missing");
...
if(!nextHtml.includes('<script src="src/core/bootstrap-next.js?v=refactor10"></script>'))fail("next bootstrap module missing");
...
if(nextHtml.indexOf('<script src="src/core/legacy-adapter.js?v=refactor10"></script>')>nextHtml.indexOf('<script src="src/modes/rack-rush.js"></script>'))fail("legacy adapter must load before Rack Rush module");
...
if(nextHtml.indexOf('<script src="src/ui/loading.js?v=refactor7"></script>')>nextHtml.indexOf('<script src="src/ui/pause.js?v=refactor10"></script>'))fail("loading must load before pause module");
if(nextHtml.indexOf('<script src="src/ui/pause.js?v=refactor10"></script>')>nextHtml.indexOf('<script src="src/core/bootstrap-next.js?v=refactor10"></script>'))fail("pause module must load before bootstrap");
if(!nextHtml.includes('<script src="src/navigation.js?v=refactor8"></script>'))fail("next navigation cache version missing");
if(nextHtml.indexOf('<script src="src/core/bootstrap-next.js?v=refactor10"></script>')>nextHtml.indexOf('<script src="src/navigation.js?v=refactor8"></script>'))fail("boot must begin before navigation rewires the loading gate");
