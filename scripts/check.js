...
if(!nextHtml.includes('<script src="src/core/legacy-adapter.js?v=refactor12"></script>'))fail("next legacy adapter missing");
...
if(nextHtml.indexOf('<script src="src/core/legacy-adapter.js?v=refactor12"></script>')>nextHtml.indexOf('<script src="src/modes/rack-rush.js"></script>'))fail("legacy adapter must load before Rack Rush module");
...
if(nextHtml.indexOf('<script src="src/ui/menu.js?v=refactor12"></script>')>nextHtml.indexOf('<script src="src/ui/pause.js?v=refactor10"></script>'))fail("menu must load before pause module");
